...
class splunk::enterprise (
  ...
  String $package_name                     = $::splunk::params::enterprise_package_name,
  String $package_ensure                   = $::splunk::params::enterprise_package_ensure,
  String $staging_subdir                   = $::splunk::params::staging_subdir,
  String $path_delimiter                   = $::splunk::params::path_delimiter,
  String $enterprise_package_src           = $::splunk::params::enterprise_package_src,
  ...
  String $enterprise_confdir               = $::splunk::params::enterprise_confdir,
  String $service_name                     = $::splunk::params::enterprise_service,
  ...
  String $password_config_file             = $::splunk::params::enterprise_password_config_file,
  String $password_content                 = $::splunk::params::password_content,
  String $secret_file                      = $::splunk::params::enterprise_secret_file,
